        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                { 
                    ...
                    {
                        RoleManager.Create(new IdentityRole(RoleName)); //Crear un rol si no existe y asignarlo
                        var userTemp = UserManager.FindByName(model.UserName);

                        if (!UserManager.IsInRole(userTemp.Id, RoleName)) //si no se encuentra asociado
                        {
